...
const (
	APIVERSION = rekorv001.APIVERSION
)
...
func (v V001Entry) CreateFromArtifactProperties(ctx context.Context, props types.ArtifactProperties) (models.ProposedEntry, error) {
	...
	if len(artifactBytes) != 0 {
		return nil, fmt.Errorf("artifact content not supported")
	}
	if props.ArtifactHash == "" {
		return nil, fmt.Errorf("artifact hash required")
	}

	re.RekordObj.Data.Hash = &models.RekordV001SchemaDataHash{}
	re.RekordObj.Data.Hash.Algorithm = swag.String(models.RekordV001SchemaDataHashAlgorithmSha256)
	re.RekordObj.Data.Hash.Value = swag.String(props.ArtifactHash)
